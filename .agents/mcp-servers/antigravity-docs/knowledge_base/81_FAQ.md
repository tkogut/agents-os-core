...
FAQ
FAQlink
Why can I not authenticate into Google Antigravity?link
...
What is Google Antigravity’s geographical availability?link
...
Antarctica
Why am I ineligible for a Google One AI plan?link
...
U.S. Virgin Islands
Wallis and Futuna
What is Google Antigravity’s stance on data collection?link

Please refer to the Terms of Service. You may opt out of data collection at any point from the Settings panel.

How do I sign in with a GCP project?link

Follow the steps in the Enterprise Page to learn how to sign in with GCP.

How do I get support?link

Check out the communities on our Support page.

What are the model rate limits?link

Please see more details in the docs on Plans.

Why can’t I use third party software (e.g. Claude Code, OpenClaw, OpenCode) with my Antigravity login?link
...
Does Google Antigravity currently support worktrees?link

Yes, you can use worktrees in Antigravity 2.0.

What happens when my computer goes to sleep?link
