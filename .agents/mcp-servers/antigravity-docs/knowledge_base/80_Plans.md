...
Google Antigravity is available with terms to individual accounts derived from Google’s terms of service, and available to teams under Google Cloud terms through the Gemini Enterprise Agent Platform. To learn more, see Enterprise Get Started.

Rate limits and model availability differs based on usage of Google AI plans. See Models for a breakdown of model availability.
